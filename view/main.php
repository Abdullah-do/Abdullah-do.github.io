			  ...
			  <section class="banner-area relative" id="home">
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8" style="margin-top: 10px;">
							...
							<a href="#" class="primary-btn text-uppercase">Visit Us Now</a>
			...
			<section class="gallery-area section-gap" id="gallery">
				<div class="container">
					...
					<div id="grid-container" class="row">
						<a class="single-gallery" href="img/gallery/egy1.jpg"><img class="grid-item" src="img/gallery/egy1.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy2.jpg"><img class="grid-item" src="img/gallery/egy2.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy3.jpg"><img class="grid-item" src="img/gallery/egy3.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy4.jpg"><img class="grid-item" src="img/gallery/egy4.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy5.jpg"><img class="grid-item" src="img/gallery/egy5.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy6.jpg"><img class="grid-item" src="img/gallery/egy6.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy7.jpg"><img class="grid-item" src="img/gallery/egy7.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy8.jpg"><img class="grid-item" src="img/gallery/egy8.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy9.jpg"><img class="grid-item" src="img/gallery/egy9.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy10.jpg"><img class="grid-item" src="img/gallery/egy10.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy11.jpg"><img class="grid-item" src="img/gallery/egy11.jpg"></a>
						<a class="single-gallery" href="img/gallery/egy12.jpg"><img class="grid-item" src="img/gallery/egy12.jpg"></a>					
					</div>	
				</div>	
			</section>
