				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8">
							...
							<h1 class="text-white">
								Story of Troy Unisex T-Shirt (L)		
							</h1>
			...
			<section class="py-5">
				<div class="container px-4 px-lg-5 my-5">
					<div class="row gx-4 gx-lg-5 align-items-center">
						<div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="shopimages/image10.jpg" alt="Story of Troy Unisex T-Shirt (L)" /></div>
						<div class="col-md-6">
							<div class="small mb-1">SKU: BST-498</div>
							<h1 class="display-5 fw-bolder">Story of Troy Unisex T-Shirt (L)</h1>
							<div class="fs-5 mb-5">
								<span >£450.00</span>
			
							</div>
							<p class="lead">The design is based on traditional black-figure scenes found on ancient Greek vases, plates and other pottery. This particular scene is inspired by a vase that shows the Greek hero Achilles slaying Penthesilea, the queen of the Amazons during the epic Trojan war. The climax of the scene shows Achilles thrusting his spear into the neck of Penthesilea at the very moment that he falls in love with her. The original vase can be seen on display in the British Museum’s collection.
	
								The story of the Trojan War is one of the best-known stories from classical mythology. The epic story tells of how the ancient Greek army won the seemingly endless siege by tricking the Trojans with the notorious wooden horse.
								
								A stylish gift inspired by ancient Greece.
