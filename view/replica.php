...
$id="replica";
$products=$productcontroller->GetreplicaProducts($id);
$errmsg="";
?>
<!DOCTYPE html>
								...
								<div class="col mb-5">
									<div class="card h-100">
										...
										<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
											<div class="text-center"><a class="btn btn-outline-dark mt-auto" href="file:///D:/wed%20development/startbootstrap-shop-item-gh-pages/profile.php">View options</a></div>
										</div>
									</div>
								</div>
								<?php
