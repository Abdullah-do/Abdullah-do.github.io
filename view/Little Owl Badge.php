				...
				<section class="py-5">
					<div class="container px-4 px-lg-5 my-5">
						<div class="row gx-4 gx-lg-5 align-items-center">
							<div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="shopimages/image2.jpg" alt="Story of Troy Unisex T-Shirt (L)" /></div>
							<div class="col-md-6">
								<div class="small mb-1">SKU: BST-258</div>
								<h1 class="display-5 fw-bolder">Little Owl Badge</h1>
								<div class="fs-5 mb-5">
									<span >£1.00</span>
