...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved.
			...
			<script src="js/jv5/vendor/jquery-2.2.4.min.js"></script>
			<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
			<script src="js/jv5/vendor/bootstrap.min.js"></script>			
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
  			<script src="js/jv5/easing.min.js"></script>			
			<script src="js/jv5/hoverIntent.js"></script>
			<script src="js/jv5/superfish.min.js"></script>	
			<script src="js/jv5/jquery.ajaxchimp.min.js"></script>
			<script src="js/jv5/jquery.magnific-popup.min.js"></script>	
			<script src="js/jv5/owl.carousel.min.js"></script>	
			<script src="js/jv5/imagesloaded.pkgd.min.js"></script>
			<script src="js/jv5/justified.min.js"></script>					
			<script src="js/jv5/jquery.sticky.js"></script>
			<script src="js/jv5/jquery.nice-select.min.js"></script>			
			<script src="js/jv5/parallax.min.js"></script>		
			<script src="js/jv5/mail-script.js"></script>	
			<script src="js/jv5/main.js"></script>	
		</body>
	</html>
