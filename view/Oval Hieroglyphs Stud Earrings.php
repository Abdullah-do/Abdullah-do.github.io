				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8">
							...
							<h1 class="text-white">
								Oval Hieroglyphs Stud Earrings	
							</h1>
				...
				<section class="py-5">
					<div class="container px-4 px-lg-5 my-5">
						<div class="row gx-4 gx-lg-5 align-items-center">
							<div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="shopimages/image1.jpg" alt="Story of Troy Unisex T-Shirt (L)" /></div>
							<div class="col-md-6">
								<div class="small mb-1">SKU: BST-258</div>
								<h1 class="display-5 fw-bolder">Oval Hieroglyphs Stud Earrings</h1>
								<div class="fs-5 mb-5">
									<span >£60.00</span>
				
								</div>
								<p class="lead">A pair of oval-shaped stud earrings with a design inspired by ancient Egyptian hieroglyphs.
		
									The earrings are part of a range accompanying the British Museum exhibition Hieroglyphs: unlocking ancient Egypt.
									</p>
								<div class="d-flex">
